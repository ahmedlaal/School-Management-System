...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $exists=false;
    if($exists==false){
       $sql =  "DELETE FROM teachers WHERE `teachers`.`tid` = '$tid'";
...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh">
    ...
    <form class ="border shadow p-4 rounded "  action= "/dbproject/deltech.php" method="post" style="width: 450px;"  >
 
     <!--------------------------- for Heading ------------------------------------->
      
      <h4 class="text-center p-3">Delete Teacher</h4> 
     ...
     <!--------------------------- for user name------------------------------------->
      ...
      <!--------------------------- for button ------------------------------------->
      <div class="mb-3">
      <button type="submit" class="btn btn-primary" name="submit" >Delete Teacher</button>
      </div> 

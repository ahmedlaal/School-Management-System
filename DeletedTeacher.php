...
session_start();
 ...
 $query = "select tid,fname,lname,date,STATUS from teacher_history ";  //join
...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh">
    ...
    <form class ="border shadow p-4 rounded "   method="post" style="width: 450px;"  >
    ...
    <!--------------------------- for Heading ------------------------------------->
      ...
      <h4 class="text-center p-3">Teacher History </h4> 
      ...
      <tr class="mb3">  
           <th class="mb3">SNo</th>  
           <th class="mb3">TID</th>  
           <th class="mb3">First Name</th>
           <th class="mb3">Last Name</th>  
           <th class="mb3">Date/Time</th>  
           <th class="mb3">Status</th>  
      </tr>  
      <?php   
      $i=1;  
